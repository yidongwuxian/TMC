export default function reducers(state = {}, action={}) {
	switch(action.type){
		case 'SET_ISINIT_ADMIN' :
			return Object.assign({}, state, {isInitAdmin:action.isInitAdmin});
		case 'SHOW_LOADING' :
	    ...
	    case 'SET_CONSOLE_URL':
	    	return Object.assign({}, state, {console_url: action.console_url})
	    case 'DEL_CONSOLE_URL':
	    	return Object.assign({}, state, {console_url: ''})
