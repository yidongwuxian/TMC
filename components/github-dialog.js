...
class GithubDialog extends Component {
	constructor(props) {
		super(props);
	}
	componentDidMount() {
	...
	saveForm = (form) => {
		...
		if(data && this.form && this.form.setFieldsValue) {
	...
	render() {
		...
		return (
			<Modal
				...
				footer={footer}
			>
				<GithubForm disabled={disabled} ref={this.saveForm} />
			</Modal>
		)
	}
}
...
export default connect()(GithubDialog);